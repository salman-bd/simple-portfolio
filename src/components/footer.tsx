...
export function Footer() {
  return (
    <footer className="bg-gradient-to-b from-violet-900 to-violet-950 overflow-hidden">
      <div className="container flex flex-col items-center gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <p className="text-sm text-muted-foreground">&copy; Shahed Imran. All Rights Reserved</p>
      </div>
    </footer>
  )
}
