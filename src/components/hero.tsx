...
export function Hero() {
  return (
    <section id="home" className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-violet-800 to-violet-950">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-6">
              <div className="flex justify-center lg:justify-start gap-4">
                {[
                  ...
                  <Link
                    key={index}
                    href={social.href}
                    className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-primary-secondary text-primary-secondary hover:bg-primary-secondary hover:text-white transition-all duration-300 transform hover:scale-110"
                  >
              ...
              <div className="flex justify-center lg:justify-start gap-4">
                <Button
                  size="lg"
                  className="bg-orange-600 hover:bg-violet-800 text-white transform hover:scale-105 transition-all duration-300"
                >
                  Hire Me
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-primary-secondary text-white hover:bg-orange-600 transform hover:scale-105 transition-all duration-300"
                >
                  Contact
                </Button>
              </div>
